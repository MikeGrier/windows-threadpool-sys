...
| [crates/windows-overlapped-io-sys/CHECKLIST.md](crates/windows-overlapped-io-sys/CHECKLIST.md) | in progress | Overlapped-I/O foundation: M11 safe `DeviceIoControl` adapters (`device`) in progress, the final family. Provenance, gated features, hardening, file read/write plus scatter/gather (`fs`), and IOCP plus blocking socket adapters (`socket`) complete. | [crates/windows-overlapped-io-sys/DESIGN-NOTES.md](crates/windows-overlapped-io-sys/DESIGN-NOTES.md) |
