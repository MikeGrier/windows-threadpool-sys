...
| [crates/windows-overlapped-io-sys/CHECKLIST.md](crates/windows-overlapped-io-sys/CHECKLIST.md) | in progress | Overlapped-I/O foundation: M10 safe blocking socket backend (`socket`) in progress; `DeviceIoControl` adapters remain. Provenance, gated features, hardening, file read/write plus scatter/gather (`fs`), and IOCP socket adapters (`socket`) complete. | [crates/windows-overlapped-io-sys/DESIGN-NOTES.md](crates/windows-overlapped-io-sys/DESIGN-NOTES.md) |
