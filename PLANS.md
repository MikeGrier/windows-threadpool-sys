...
| [crates/windows-overlapped-io-sys/CHECKLIST.md](crates/windows-overlapped-io-sys/CHECKLIST.md) | in progress | Overlapped-I/O foundation: M9 safe IOCP socket adapters (`socket`) in progress; blocking-socket backend and `DeviceIoControl` adapters remain. Provenance, gated features, hardening, and file read/write plus scatter/gather adapters (`fs`) complete. | [crates/windows-overlapped-io-sys/DESIGN-NOTES.md](crates/windows-overlapped-io-sys/DESIGN-NOTES.md) |
