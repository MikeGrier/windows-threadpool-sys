...
| [crates/windows-overlapped-io-sys/CHECKLIST.md](crates/windows-overlapped-io-sys/CHECKLIST.md) | in progress | Overlapped-I/O foundation: horizon safe adapters for other operation families remain. Provenance, gated features, behavioral-matrix / shared-port drain hardening, and safe file read/write adapters (`fs`) complete. | [crates/windows-overlapped-io-sys/DESIGN-NOTES.md](crates/windows-overlapped-io-sys/DESIGN-NOTES.md) |
