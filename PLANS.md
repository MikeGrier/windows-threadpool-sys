...
| [crates/windows-overlapped-io-sys/CHECKLIST.md](crates/windows-overlapped-io-sys/CHECKLIST.md) | in progress | Overlapped-I/O foundation: M8 safe scatter/gather adapters (`fs`) in progress; socket and `DeviceIoControl` adapters remain. Provenance, gated features, behavioral-matrix / shared-port drain hardening, and safe file read/write adapters complete. | [crates/windows-overlapped-io-sys/DESIGN-NOTES.md](crates/windows-overlapped-io-sys/DESIGN-NOTES.md) |
