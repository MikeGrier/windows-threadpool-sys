...
| [crates/windows-overlapped-io-sys/CHECKLIST.md](crates/windows-overlapped-io-sys/CHECKLIST.md) | in progress | Overlapped-I/O foundation: horizon socket and `DeviceIoControl` adapters remain. Provenance, gated features, behavioral-matrix / shared-port drain hardening, and safe file read/write plus scatter/gather adapters (`fs`) complete. | [crates/windows-overlapped-io-sys/DESIGN-NOTES.md](crates/windows-overlapped-io-sys/DESIGN-NOTES.md) |
