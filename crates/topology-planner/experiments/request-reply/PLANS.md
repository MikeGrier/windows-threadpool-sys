...
|---|---|---|---|
| [CHECKLIST.md](../../CHECKLIST.md) | in progress | EP-X2.2 and EP-X2.3 are complete in the parent's [COMPLETED-CHECKLIST.md](../../COMPLETED-CHECKLIST.md#ep-x23). Return to parent EP-R1.7.1 before further experiments; the parent program remains open. | [DESIGN-NOTES.md](DESIGN-NOTES.md) |
