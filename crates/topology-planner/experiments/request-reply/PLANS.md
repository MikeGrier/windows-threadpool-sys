...
|---|---|---|---|
| [CHECKLIST.md](../../CHECKLIST.md) | in progress | EP-X2.2, EP-X2.3 and EP-X2.4 are complete in the parent's [COMPLETED-CHECKLIST.md](../../COMPLETED-CHECKLIST.md#ep-x24). Three paths are retained here: stateless request/reply, keyed state, and ordered ingestion. All experiments are paused; return to parent EP-R1.7.1. | [DESIGN-NOTES.md](DESIGN-NOTES.md) |
