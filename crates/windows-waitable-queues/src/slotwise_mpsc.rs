...
use crate::error::{CapacityError, PushError, RecvError, RecvTimeoutError, TryRecvError};
...
/// less than two, or exceeds `2^(usize::BITS - 2)`.
///
/// # Examples
///
/// ```
/// use windows_waitable_queues::{slotwise_mpsc, TryRecvError};
///
