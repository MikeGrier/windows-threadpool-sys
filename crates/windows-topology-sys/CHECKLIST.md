...
Plan status is tracked in [PLANS.md](PLANS.md) and [COMPLETED-PLANS.md](COMPLETED-PLANS.md). New work
against this crate reopens a milestone here and adds a row back to `PLANS.md`.
