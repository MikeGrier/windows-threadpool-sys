# Completed checklist: windows-topology-sys
...
This file is append-only; new completed groups are added at the bottom.

## Moved 2026-08-22 -- M1 through M4: safe enumeration, the description, serialization, and documentation
...
- [x] **M4.1** -- Crate docs leading with what this is and is not: enumeration, not a renderer; no policy;
...
- [x] **M4.2** -- A worked example printing the host's topology as JSON -- the thing a consumer will want
