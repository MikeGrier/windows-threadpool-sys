...
## <a id="m10"></a>Moved 2026-09-09 -- M10 -- Failure detail on every fault report (D-79, PR #20 review response)
...
## <a id="m11"></a>Moved 2026-09-09 -- M11 -- Reopen identity: file-reference-based reopen, and volume-identity tracking (D-78 groundwork)
...
## <a id="m15"></a>Moved 2026-09-09 -- M15 -- Findings from the mutation-testing sweep
