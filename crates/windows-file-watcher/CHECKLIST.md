...
Tier-1 decisions land in [DESIGN-NOTES.md](DESIGN-NOTES.md) as milestones complete.
...
- [x] **M1.2** — Seed Tier-1 [DESIGN-NOTES.md](DESIGN-NOTES.md) and Tier-2 [DESIGN-RATIONALE.md](DESIGN-RATIONALE.md) from
