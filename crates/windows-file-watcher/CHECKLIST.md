...
The authoritative Tier-1 set is [DESIGN-NOTES.md](DESIGN-NOTES.md), which now runs to **D-40** -- later
decisions (D-21 from M1 review, D-22 from M2.1, D-23/D-24 from M2.2, D-26 from M2.3, D-34 from M2.4, D-35
from M2.5, D-36/D-37 from M3.1, D-38 from M3.2, D-39/D-40 from M3.3, D-32 from M8.1, and D-25/D-27...D-31 plus D-33 from the [2026-08-21 fault-protocol session](design-sessions/DESIGN-SESSION-2026-08-21-fault-protocol-and-doorbells.md),
...
> **NEXT ACTIONABLE ITEM: M3.4.** M1 and M2 are archived and M3.1...M3.3 are complete; nothing else is in
