...
| [CHECKLIST-mutation-hardening.md](COMPLETED-CHECKLIST.md#checklist-mutation-hardening) (deleted on completion; the link opens its archived entry) | 2026-09-01 | Added direct unit coverage for all 14 survivors from the full mutation run. The rerun tested 132 mutants: 97 caught, 35 unviable, 0 missed, and 0 timed out. | N/A |
