...
> **The "meaningful on Intel and ARM too" clause is false on a shipping ARM part** ([D-48](#d-48)): that
> machine reports no L3 domain at all, and its natural cluster boundary is L2. The finding that L3 beats
> the NUMA node is unaffected. Restating the rule and sweeping its restatements is `M20.1` in
> [CHECKLIST.md](CHECKLIST.md), which is coupled to `SH-4.12`.
...
**The first is under re-examination by [D-49](#d-49) / `M24.1`, and stands until that concludes.**
